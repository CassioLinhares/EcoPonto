...
fun CadastroScreen(navController: NavHostController) {
    Column(
        ...
        Row(
            ...
            BackButtonComponentcadastro(onClick = {}, navController = navController)
        }
...
@Composable
fun BackButtonComponentcadastro(
...
fun CadastroUserForm(modifier: Modifier = Modifier, navController: NavHostController) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth(),
            label = { Text(text = "Nome", style = MaterialTheme.typography.labelSmall) },
